    ...
    <div ref={containerRef} style={{ height: "300vh", position: "relative" }}>
      <div
        style={{
          ...
          height: "100vh",
          overflow: "hidden",
          // Poster: show the first frame instantly via CSS so the hero is
          // never blank while the canvas frames load. The opaque canvas draws
          // the same frame on top once ready, so the handoff is invisible.
